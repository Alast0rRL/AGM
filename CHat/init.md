...
### Сценарий 3: Возраст + "а тебе?" в одном сообщении

```
[Stage 1]
Bot → "сколько лет"
Partner → "18, а тебе?"    ← возраст + вопрос в одном
Bot → "19"                 ← отвечаем "19", не "Тож"
✓ Возраст принят, "а тебе?" обработан
```

**Важно:** если "а тебе?" приходит вместе с возрастом ("18, а тебе?"), бот отвечает "19" (а не "Тож").
