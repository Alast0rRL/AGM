...
assert_false("опыт с мусульманками", is_muslim("у меня не было опыта с тем у кого был опыт с мусульманками"))
...
assert_false("норм? не паттерн", _how("норм?"))
assert_false("ну норм не паттерн", _how("ну норм"))
